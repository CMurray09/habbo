        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <jet-input id="habbocode" class="col-span-2" type="text" readonly value="HabboDome-Update"/>
                    <jet-button id="copycode" type="button" class="col-span-1" v-on:click="copyToClipboard()">Copy
                    </jet-button>
                </div>
            </div>
        </template>
